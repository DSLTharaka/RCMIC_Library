            ...
            else
            {
                if(connect.State == ConnectionState.Closed)
                {
                    try
                    {
                        ...
                        string path = Path.Combine(@"E:\Develpoments\Regiment\Library-Management-System-using-CSharp-main\LibraryManagementSystem\LibraryManagementSystem\Books_Directory\" +
